  ...
  return (
    <>
      <div className="termsClass">
        ...
        <h6>GENERAL TERMS AND CONDITIONS FOR INDIVIDUAL GUESTS & GROUPS</h6>
        <h6>INDIVIDUAL GUESTS</h6>
        <p className="p-bold-t">Room reservation’s procedure</p>
        ...
        <p className="p-normal-t">
          All individual’s stay must be guaranteed by a credit card at the
          moment of reservation. The card will be charged at the moment of
          check-in. Extras and eventually additional services will be charged at
          the moment of check-out.
        </p>
        ...
        <p className="p-bold-t">Reduction of length of stay</p>
        <p className="p-normal-t">
          For any shortening in the length of stay will automatically incur a
          one-night credit only and that after third day otherwise full charge.
          Exceptions can be made only in case of emergency need such as
          accidents, death, sickness or similar.
        </p>
        <p className="p-bold-t">Small Groups Cancellation Policy</p>
        <p className="p-normal-t">
          For small group reservations (more than 5 rooms for more than 3
          nights) guests will be charged at the moment of reservation the 30% of
